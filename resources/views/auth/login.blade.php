...
<div class="block mx-auto my-12 p-8 bg-white w-1/3 border border-gray-200 rounded-lg shadow-lg">
    <h1 class="text-3xl text-center font-bold">Login de usuarios</h1>
    ...
    <form class="mt-4" method="post" action="">
        ...
        <button type="submit" class="rounded-md bg-red-700 w-full text-lg text-white font-semibold p-2 my-3 hover:bg-red-600">Iniciar Sesion</button>
